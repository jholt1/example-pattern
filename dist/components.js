...
var PropertiesChanged = dedupingMixin(function (superClass) {
  ...
  var PropertiesChanged = function (_superClass) {
     ...
     * @protected
     */
    PropertiesChanged.createProperties = function createProperties(props) {
    ...
    PropertiesChanged.attributeNameForProperty = function attributeNameForProperty(property) {
    ...
    PropertiesChanged.typeForProperty = function typeForProperty(name) {}; //eslint-disable-line no-unused-vars
    ...
    PropertiesChanged.prototype._createPropertyAccessor = function _createPropertyAccessor(property, readOnly) {
    ...
    PropertiesChanged.prototype._addPropertyToAttributeMap = function _addPropertyToAttributeMap(property) {
    ...
    PropertiesChanged.prototype._definePropertyAccessor = function _definePropertyAccessor(property, readOnly) {
    ...
    PropertiesChanged.prototype.ready = function ready() {
    ...
    PropertiesChanged.prototype._initializeProperties = function _initializeProperties() {
    ...
    PropertiesChanged.prototype._initializeInstanceProperties = function _initializeInstanceProperties(props) {
    ...
    PropertiesChanged.prototype._setProperty = function _setProperty(property, value) {
    ...
    PropertiesChanged.prototype._getProperty = function _getProperty(property) {
    ...
    PropertiesChanged.prototype._setPendingProperty = function _setPendingProperty(property, value, ext) {
    ...
    PropertiesChanged.prototype._invalidateProperties = function _invalidateProperties() {
      var _this2 = this;
    ...
    PropertiesChanged.prototype._enableProperties = function _enableProperties() {
    ...
    PropertiesChanged.prototype._flushProperties = function _flushProperties() {
    ...
    PropertiesChanged.prototype._shouldPropertiesChange = function _shouldPropertiesChange(currentProps, changedProps, oldProps) {
    ...
    PropertiesChanged.prototype._propertiesChanged = function _propertiesChanged(currentProps, changedProps, oldProps) {} // eslint-disable-line no-unused-vars
    ...
    PropertiesChanged.prototype._shouldPropertyChange = function _shouldPropertyChange(property, value, old) {
      return (
    ...
    PropertiesChanged.prototype.attributeChangedCallback = function attributeChangedCallback(name, old, value, namespace) {
      if (old !== value) {
        this._attributeToProperty(name, value);
      }
      if (_superClass.prototype.attributeChangedCallback) {
        _superClass.prototype.attributeChangedCallback.call(this, name, old, value, namespace);
      }
    };
    ...
    PropertiesChanged.prototype._attributeToProperty = function _attributeToProperty(attribute, value, type) {
    ...
    PropertiesChanged.prototype._propertyToAttribute = function _propertyToAttribute(property, attribute, value) {
    ...
    PropertiesChanged.prototype._valueToNodeAttribute = function _valueToNodeAttribute(node, value, attribute) {
    ...
    PropertiesChanged.prototype._serializeValue = function _serializeValue(value) {
    ...
    PropertiesChanged.prototype._deserializeValue = function _deserializeValue(value, type) {
      switch (type) {
        case Boolean:
          return value !== null;
        case Number:
...
var PropertiesMixin = dedupingMixin(function (superClass) {
  ...
  var PropertiesMixin = function (_base) {
     ...
     * @return {void}
     */
    PropertiesMixin.finalize = function finalize() {
    ...
    PropertiesMixin._finalizeClass = function _finalizeClass() {
     ...
     * @protected
     */
    PropertiesMixin.typeForProperty = function typeForProperty(name) {
    ...
    PropertiesMixin.prototype._initializeProperties = function _initializeProperties() {
      this.constructor.finalize();
      _base.prototype._initializeProperties.call(this);
    };
    ...
    PropertiesMixin.prototype.connectedCallback = function connectedCallback() {
      if (_base.prototype.connectedCallback) {
    ...
    PropertiesMixin.prototype.disconnectedCallback = function disconnectedCallback() {
      if (_base.prototype.disconnectedCallback) {
        _base.prototype.disconnectedCallback.call(this);
      }
    };

    createClass(PropertiesMixin, null, [{
...
var Template = function Template(result, element) {
    ...
    for (var _iterator = nodesToRemove, _isArray = Array.isArray(_iterator), _i2 = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref;
...
var AttributePart = function () {
    ...
    AttributePart.prototype._interpolate = function _interpolate(values, startIndex) {
        ...
        for (var i = 0; i < l; i++) {
            ...
            if (v && v !== noChange && (Array.isArray(v) || typeof v !== 'string' && v[Symbol.iterator])) {
                for (var _iterator2 = v, _isArray2 = Array.isArray(_iterator2), _i3 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
                    var _ref2;
    ...
    AttributePart.prototype._equalToPreviousValues = function _equalToPreviousValues(values, startIndex) {
...
var NodePart = function () {
    ...
    NodePart.prototype._setIterable = function _setIterable(value) {
        ...
        var partIndex = 0;
        for (var _iterator3 = value, _isArray3 = Array.isArray(_iterator3), _i4 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
            var _ref3;
...
var TemplateInstance = function () {
    ...
    TemplateInstance.prototype.update = function update(values) {
        var valueIndex = 0;
        for (var _iterator4 = this._parts, _isArray4 = Array.isArray(_iterator4), _i5 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
            var _ref4;
...
var BooleanAttributePart = function (_AttributePart) {
    ...
    BooleanAttributePart.prototype.setValue = function setValue(values, startIndex) {
        var s = this.strings;
        if (s.length === 2 && s[0] === '' && s[1] === '') {
...
var PropertyPart = function (_AttributePart2) {
    ...
    function PropertyPart() {
        ...
        return possibleConstructorReturn(this, _AttributePart2.apply(this, arguments));
    }
...
var LitElement = function (_PropertiesMixin) {
    ...
    function LitElement() {
        ...
        var _this = possibleConstructorReturn(this, _PropertiesMixin.apply(this, arguments));
    ...
    LitElement.prototype.ready = function ready() {
        this._root = this._createRoot();
        _PropertiesMixin.prototype.ready.call(this);
        this._firstRendered();
    };
    ...
    LitElement.prototype.connectedCallback = function connectedCallback() {
        ...
        _PropertiesMixin.prototype.connectedCallback.call(this);
    };
    /**
    ...
    LitElement.prototype._firstRendered = function _firstRendered() {};
    /**
    ...
    LitElement.prototype._createRoot = function _createRoot() {
    ...
    LitElement.prototype._shouldPropertiesChange = function _shouldPropertiesChange(_props, _changedProps, _prevProps) {
    ...
    LitElement.prototype._shouldRender = function _shouldRender(_props, _changedProps, _prevProps) {
        return true;
    };
    /**
    ...
    LitElement.prototype._propertiesChanged = function _propertiesChanged(props, changedProps, prevProps) {
        _PropertiesMixin.prototype._propertiesChanged.call(this, props, changedProps, prevProps);
    ...
    LitElement.prototype._flushProperties = function _flushProperties() {
        this.__isChanging = true;
        this.__isInvalid = false;
        _PropertiesMixin.prototype._flushProperties.call(this);
    ...
    LitElement.prototype._shouldPropertyChange = function _shouldPropertyChange(property, value, old) {
        var change = _PropertiesMixin.prototype._shouldPropertyChange.call(this, property, value, old);
    ...
    LitElement.prototype._render = function _render(_props) {
    ...
    LitElement.prototype._applyRender = function _applyRender(result, node) {
    ...
    LitElement.prototype._didRender = function _didRender(_props, _changedProps, _prevProps) {};
    /**
    ...
    LitElement.prototype.requestRender = function requestRender() {
        this._invalidateProperties();
    };
    /**
    ...
    LitElement.prototype._invalidateProperties = function _invalidateProperties() {
        this.__isInvalid = true;
        _PropertiesMixin.prototype._invalidateProperties.call(this);
    };
    /**
...
var nsButton = function (_LitElement) {
  inherits(nsButton, _LitElement);
  createClass(nsButton, null, [{
    key: 'properties',
  ...
  nsButton.prototype._render = function _render(_ref) {
    var type = _ref.type,
